...
{
    class MinervaEssence
    {
        public static string IDName = "MinervaEssence";
        ...
        public static CardUpgradeDataBuilder Builder()
        {
            CardUpgradeDataBuilder railtie = new CardUpgradeDataBuilder
            {
                ...
                SourceSynthesisUnit = Trainworks.Managers.CustomCharacterManager.GetCharacterDataByID("Minerva Owl"),
